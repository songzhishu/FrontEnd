 ...
 * @Date: 2024-07-12 14:35:41
 * @LastEditors: 宋之树 2334304096@qq.com
 * @LastEditTime: 2024-07-12 17:13:34
 * @FilePath: \FrontEnd\AJAX\day05\hmtt\page\publish\index.js
 * @Description: 
 */
/**
 * 目标1：设置频道下拉菜单
...
async function setChanleList() {
    ...
    const htmlStr = res.data.channels.map(item => ` <option value="${item.id}" selected>${item.name}</option>`).join('')
